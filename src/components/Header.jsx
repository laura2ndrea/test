    ...
    >
      ...
      <div className="flex basis-1/2 p-2 px-4 items-center justify-end gap-x-4 md:basis-[36%] md:justify-between md:gap-x-2 lg:basis-[30%] bg-yellow-500">
        <div>
          <FontAwesomeIcon
            icon={faBell}
            className="mr-2 bg-[#FBF2E5] text-secondary-color p-[6px] transform transition duration-400 hover:scale-115 rounded-lg"
          />
          <FontAwesomeIcon
            icon={faEnvelope}
            className="bg-[#E3F4E9] text-primary-color p-[6px]  transform transition duration-400 hover:scale-115 rounded-lg"
          />
        </div>
        <UserCard
          image={user.image}
